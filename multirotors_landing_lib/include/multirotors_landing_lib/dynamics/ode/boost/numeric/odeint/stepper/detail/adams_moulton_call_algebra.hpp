...
struct adams_moulton_call_algebra<1, Algebra, Operations> {
  template <class StateIn, class StateOut, class DerivIn, class StepStorage,
            class Coefficients, class Time>
  void operator()(Algebra &algebra, const StateIn &in, StateOut &out,
                  const DerivIn &dxdt, const StepStorage &steps,
...
struct adams_moulton_call_algebra<3, Algebra, Operations> {
  ...
  void operator()(Algebra &algebra, const StateIn &in, StateOut &out,
    ...
    typedef typename Coefficients::value_type value_type;
    algebra.for_each5(
        out, in, dxdt, steps[0].m_v, steps[1].m_v,
...
struct adams_moulton_call_algebra<4, Algebra, Operations> {
  ...
  void operator()(Algebra &algebra, const StateIn &in, StateOut &out,
    ...
    typedef typename Coefficients::value_type value_type;
    algebra.for_each6(
        out, in, dxdt, steps[0].m_v, steps[1].m_v, steps[2].m_v,
...
struct adams_moulton_call_algebra<5, Algebra, Operations> {
  ...
  void operator()(Algebra &algebra, const StateIn &in, StateOut &out,
    ...
    typedef typename Coefficients::value_type value_type;
    algebra.for_each7(
        out, in, dxdt, steps[0].m_v, steps[1].m_v, steps[2].m_v, steps[3].m_v,
