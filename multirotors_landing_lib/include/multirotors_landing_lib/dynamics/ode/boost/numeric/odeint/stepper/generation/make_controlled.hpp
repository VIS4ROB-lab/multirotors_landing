/*
 ...
 [begin_description]
 Factory function to simplify the creation of controlled steppers from error
...
struct controller_factory {
  Controller operator()(typename Stepper::value_type abs_error,
...
typename result_of::make_controlled<Stepper>::type make_controlled(
  ...
  typedef
      typename result_of::make_controlled<stepper_type>::type controller_type;
