/*
 ...
 [begin_description]
 An algebra for types which have vector space semantics, hence types on which
 the operators +,-,* are well defined. [end_description]
...
/*
 * This class template has to be overload in order to call
 * vector_space_algebra::reduce
 */
