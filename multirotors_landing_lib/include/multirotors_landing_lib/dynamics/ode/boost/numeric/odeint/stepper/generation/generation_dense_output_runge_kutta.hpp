/*
 ...
 [begin_description]
 Specialization of the controller factory for the dense_output_runge_kutta
 class. [end_description]
...
struct dense_output_factory<
    Stepper, dense_output_runge_kutta<controlled_runge_kutta<Stepper> > > {
  ...
  dense_output_type operator()(value_type abs_error, value_type rel_error,
    ...
    return dense_output_type(
        controller_type(error_checker_type(abs_error, rel_error), stepper));
  }
};
